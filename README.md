...
- Encryption keys are placeholders
...
3. Restore or replace any required Firebase / platform configuration files with your own Firebase project.
4. Open a scene from Assets/Scenes.
5. Enter Play Mode or build to a supported mobile platform.
